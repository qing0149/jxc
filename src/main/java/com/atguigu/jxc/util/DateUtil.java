...
public class DateUtil {
    ...
    public static boolean isScopeTime(String damageDate, String sTime, String eTime) {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
        LocalDate dDate = LocalDate.parse(damageDate, dateTimeFormatter);
        LocalDate startTime = LocalDate.parse(sTime, dateTimeFormatter);
        LocalDate endTime = LocalDate.parse(eTime, dateTimeFormatter);
        return dDate.isAfter(startTime) && dDate.isBefore(endTime) ? true : false;
    }
}
